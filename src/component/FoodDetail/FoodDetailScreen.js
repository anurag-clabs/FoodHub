  ...
  return (
    <SafeAreaView style={commonStyle.constainer}>
      <ScrollView>
        ...
        <Text style={[commonStyle.m_20, commonStyle.v_10, styles.headerTxt]}>
          Ground Beef Tacos
        </Text>
        <View style={[commonStyle.rowCenter]}>
          <TouchableOpacity
            style={[styles.FavoritesreviewTxtView, commonStyle.m_20]}>
        ...
        <View
          style={[commonStyle.rowSpace, commonStyle.mT10, commonStyle.m_20]}>
