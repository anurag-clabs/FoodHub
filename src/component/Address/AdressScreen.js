...
const AdressScreen = () => {
  ...
  const getUserAddressDetail = useSelector(
    state => state?.GetUserAddress?.getAddressData,
  );
      ...
      {loader ? (
        ...
        <ScrollView
          ...
          <View style={[commonStyle.m_20]}>
            ...
            Array.isArray(getUserAddressDetail) &&
            getUserAddressDetail.length > 0 ? (
              getUserAddressDetail.map((address, index) => (
                <View
                  style={[styles.addressBox, commonStyle.blackShadow]}
                  key={index}>
                  ...
                  <Text style={styles.addressDataTxt}>
                    Phone :{' '}
                    <Text style={styles.numberText}>{address.number}</Text>
                  </Text>
                  ...
                  <View style={commonStyle.flexRow}>
                    ...
                    <TouchableOpacity
                      onPress={() =>
                        navigation.navigate('AddresseTextInput', {
                          addressData: address,
                          type: 'edit',
                        })
                      }>
              ...
              <Text style={[styles.noDataTxt, commonStyle.mT30]}>
                {getUserAddressDetail.message}
              </Text>
            )}
          </View>
        </ScrollView>
